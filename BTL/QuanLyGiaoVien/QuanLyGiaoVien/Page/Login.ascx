...
<table width="200px">
    <tr>
        <td align="center" style="background-color: yellowgreen; color: White; font-weight: bold">Đăng nhập
        </td>
    </tr>
    <tr>
        <td>User name:
            ...
            Password:
            <br />
            <asp:TextBox runat="server" ID="txtPassword" Width="92%" TextMode="Password"></asp:TextBox>
            <br />
        </td>
    </tr>
    <tr>
